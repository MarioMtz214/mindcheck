...
@section('body')
    <div class="h-[100%]  bg-gray-50 snap-y snap-mandatory"> 
        <div class="flex flex-row h-[70%] snap-center">
            ...
            {{-- panel --}}
            <div class="w-10/12"> 
                <div class="flex flex-1 flex-col w-full h-[80%]  p-4 px-6 ">
                    <div class="flex flex-row items-center h-1/4">
                        <div class="w-2/3 h-full ">
                            <h1 class="text-4xl text-gray-200">Bienvenido</h1>
                        </div>
                        <div class="flex flex-col justify-end items-end w-1/3 h-full space-y-4 ">
                            <h1 class="w-2/3 text-xl text-gray-200 p-2 rounded-lg bg-white shadow-2xl shadow-gray-200">usuarios</h1>
                            <h1 class="w-2/3 text-xl text-gray-200 p-2 rounded-lg bg-white shadow-2xl shadow-gray-200">usuarios</h1>
                        </div>
                    </div>
                    <div class="flex flex-row justify-center items-center h-3/4 space-x-9 ">
            ...
            {{-- barra de progreso --}}
            <div class="flex flex-col item-center p-4 w-1/12 "> 
                <div class="flex flex-col justify-start items-center h-full">
                    ...
                    <div class="flex flex-col justify-end items-center bg-gray-200 w-10 h-[60%] rounded-full">
                        <div class="flex flex-col justify-end bg-green-400 w-10 h-[80%] rounded-full">
                            <div class="flex flex-col justify-end bg-yellow-400 w-10 h-[70%] rounded-full">
                                <div class="bg-red-600 w-10 h-[30%] rounded-full"></div>
                            </div>
                        </div>
                    </div>
