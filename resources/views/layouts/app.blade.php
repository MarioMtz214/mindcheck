...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body x-data="{ open: false }"  class="flex flex-row w-full">
        ...
        <div class="w-1/12 h-screen bg-red-500 rounded-br-3xl" :class="{'block': !open, 'hidden': open}">
            ...
            {{-- <div class="w-full bg-blue-500 flex flex-row justify-center items-center pt-10">
                <h1 class="font-extralight sm:text-sm xl:text-md 2xl:text-2xl text-white" >MindCheck</h1>
            </div> --}}
