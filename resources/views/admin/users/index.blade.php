    ...
    <div class="p-4 text-gray-600 flex flex-col gap-4 mt-4">
        <div class="border-b-2">
            <div class="flex flex-row justify-between items-center">
                ...
                <a href="{{ route('admin.users.createview') }}"
                    class="px-4 py-2 bg-zinc-300 text-black rounded-md hover:bg-red-500 hover:text-white transition duration-300 ease-in-out">
        ...
        <div>
            <form action="{{ route('admin.users.search') }}"
                ...
                <div class="flex w-full focus:outline-none focus:ring-2 focus:ring-red-400 border-b-2 ">
                    <input type="text" id="searchInput" name="searchInput"
                        class="flex-grow rounded-l-xl border px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-none"
                        placeholder="Search...">
                    <div class="relative">
                        <select id="searchCategory" name="searchCategory"
                            class="block appearance-none rounded-r-xl border-l-0 border bg-white px-4 py-2 pr-8 focus:outline-none focus:ring-2 focus:border-none focus:ring-red-400">
                ...
                <tbody>
                    ...
                    @if (isset($filterByRole))
                        @foreach ($users as $user)
                            <tr class="border-b bg-gray-100">
                                ...
                                <td class="p-3 px-5">{{ $user->role->name ?? 'Sin rol' }}</td>
                    ...
                    @elseif (isset($filterByCourse))
                        @foreach ($students as $student)
                            <tr class="border-b bg-gray-100">
                                ...
                                <td class="p-3 px-5 flex justify-end">
                                    <button type="button" href="{{ route('admin.users.edit', $student->user_id) }}"
                                        class="mr-3 text-sm text-black hover:bg-customGreen hover:text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">
                    ...
                    @elseif(isset($filterByName))
                        @foreach ($results as $result)
                            <tr class="border-b bg-gray-100">
                                <td class="p-3 px-5">{{ $result->name }}</td>
                                ...
                                <td class="p-3 px-5 flex justify-end">
                                    <button type="button"
                                        class="mr-3 text-sm text-black hover:bg-customGreen hover:text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">
                                        <a href="{{ route('admin.users.edit', $result->id) }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        @foreach ($results as $result)
                            <tr class="border-b bg-gray-100">
                                ...
                                <td class="p-3 px-5 flex justify-end">
                                    <button type="button"
                                        class="mr-3 text-sm text-black hover:bg-customGreen hover:text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">
                                        <a href="{{ route('admin.users.edit', $result->user_id) }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        ...
                        <a href="{{ route('admin.users.delete', '0') }}"
